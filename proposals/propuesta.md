...
- **Dependencias**: Librerías en Python:  Librerías en Python: csv (para la escritura del reporte), Pillow (para EXIF de imágenes), piexif, librerías específicas para documentos en caso de que nos sean necesarias (python-docx, PyPDF2, etc). 
